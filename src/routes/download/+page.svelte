...
>
  ...
  >
    <div class="flex flex-col items-center justify-center gap-4 mb-12">
      <div class="w-full max-w-2xl flex flex-col gap-6">
        <div
          class={`rounded-2xl border border-zinc-200/50 dark:border-white/10 bg-[#f5faff] dark:bg-gradient-to-b dark:from-zinc-900/50 dark:to-black/20 backdrop-blur-md p-6 sm:p-8 flex flex-col items-center gap-6 shadow-sm relative overflow-hidden ${clientOS === "mac" ? "order-1" : "order-2"}`}
        >
          ...
          <div class="w-full flex items-center justify-between gap-3 relative z-10">
            <div class="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-6 text-zinc-900 dark:text-zinc-100">
            ...
            {#if clientOS === "mac"}
              <span class="rounded-full bg-cyan-500/10 border border-cyan-500/20 px-3 py-1 text-xs font-semibold text-cyan-700 dark:text-cyan-300">
          ...
          <div class="w-full relative z-10 flex flex-col gap-6">
            ...
            <div class="rounded-xl overflow-hidden border border-zinc-200 dark:border-white/10 shadow-lg shadow-zinc-200/50 dark:shadow-black/50 bg-[#1e1e1e]">
              <!-- Terminal Header -->
              <div class="bg-zinc-100 dark:bg-[#2d2d2d] px-4 py-2.5 flex items-center justify-between border-b border-zinc-200 dark:border-white/5">
                <div class="flex gap-1.5">
                  <div class="w-3 h-3 rounded-full bg-[#ff5f56]"></div>
                  <div class="w-3 h-3 rounded-full bg-[#ffbd2e]"></div>
                  <div class="w-3 h-3 rounded-full bg-[#27c93f]"></div>
                </div>
                <div class="text-[11px] font-medium text-zinc-500 dark:text-zinc-400 flex items-center gap-1.5">
                  <Terminal size={12} />
              ...
              <!-- Terminal Body -->
              <div class="p-5 font-mono text-sm leading-relaxed overflow-x-auto text-[#d4d4d4]">
                <div class="flex items-start group">
                  ...
                  <div class="flex-1 relative">
                    <input
                      ...
                      class="bg-transparent w-full outline-none truncate cursor-copy text-[#ce9178] selection:bg-[#264f78]"
                    />
                    <div class="absolute right-0 top-1/2 -translate-y-1/2 bg-gradient-to-l from-[#1e1e1e] pl-8 py-2 opacity-0 group-hover:opacity-100 transition-opacity flex items-center">
                      <button
                        onclick={copyMacLink}
        ...
        <div
          class={`rounded-2xl border border-zinc-200/50 dark:border-white/10 bg-[#f5faff] dark:bg-zinc-900/40 p-6 sm:p-8 flex flex-col items-center gap-5 shadow-sm ${clientOS === "mac" ? "order-2" : "order-1"}`}
        >
          <div class="w-full flex items-center justify-between gap-3">
            <div class="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 text-zinc-900 dark:text-zinc-100">
            ...
            {#if clientOS === "windows"}
              <span class="rounded-full bg-cyan-500/10 px-3 py-1 text-xs font-semibold text-cyan-700 dark:text-cyan-300">
                Recommended for your device
              </span>
            {/if}
          </div>
  ...
  <div class="mt-8 rounded-2xl border border-zinc-200 dark:border-white/10 bg-zinc-50/70 dark:bg-zinc-900/30 p-6 sm:p-7">
