...
{:else}
  <div class="flex flex-col gap-6">
    ...
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4 border-b border-zinc-200 pb-8 dark:border-zinc-800 xl:border-r-0">
      <div class="border-l-2 border-zinc-200 pl-4 py-2 dark:border-zinc-800 xl:border-r-0">
      ...
      <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {#if snapshot.reports.length}
          {#each snapshot.reports.slice(0, 12) as report}
            <div class="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm transition-all hover:bg-zinc-50 dark:border-zinc-800 xl:border-r-0 dark:bg-zinc-900/50 dark:hover:bg-zinc-900">
          ...
          <div class="p-6 space-y-8 flex-1">
            <div>
              ...
              <div class="grid gap-4 sm:grid-cols-2">
                <div class="rounded-lg border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 xl:border-r-0 dark:bg-zinc-900/50">
              ...
              <div class="space-y-2">
                {#if activeTeam.reportData.appUsage.length}
                  {#each activeTeam.reportData.appUsage.slice(0, 8) as app}
                    <div class="flex items-center justify-between rounded-lg border border-zinc-100 bg-zinc-50/50 px-4 py-3 dark:border-zinc-800 xl:border-r-0/40 dark:bg-zinc-800/20">
              ...
              <div class="space-y-3">
                {#if (activeTeam.syncData.activityEvents || []).length}
                  {#each [...(activeTeam.syncData.activityEvents || [])].slice(-10).reverse() as event}
                    <div class="rounded-lg border border-zinc-100 p-4 dark:border-zinc-800 xl:border-r-0/40 bg-white/20 dark:bg-zinc-900/20">
