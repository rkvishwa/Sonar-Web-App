...
<div class="px-4 sm:px-6 pt-6 sm:pt-10 pb-12 sm:pb-20 lg:pt-16 lg:pb-24 max-w-5xl mx-auto w-full transition-colors duration-200">
  ...
  <section class="mb-12 sm:mb-20 overflow-hidden relative bg-zinc-950 dark:bg-zinc-900/40 rounded-[2rem] p-1 shadow-2xl transition-colors duration-200">
    ...
    <div class="relative bg-zinc-900 dark:bg-zinc-950/80 rounded-[30px] p-6 sm:p-12 border border-white/5 backdrop-blur-sm text-center">
      <h2 class="text-2xl sm:text-4xl font-extrabold text-white mb-4 tracking-tight">Connect with knurdz<span class="text-[#00c950]">.org</span></h2>
      <p class="text-zinc-400 max-w-xl mx-auto mb-10 leading-relaxed sm:text-lg">
      ...
      <div class="flex flex-wrap justify-center gap-4 sm:gap-6">
        <a href="https://knurdz.org" target="_blank" rel="noreferrer" class="group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-white/5 hover:bg-zinc-800 rounded-2xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-zinc-800/30" title="Website">
          <Globe size={28} class="text-zinc-300 group-hover:text-white transition-colors duration-300" />
        </a>
        <a href="https://whatsapp.com/channel/0029Vb7mzSE90x2oxIk9D31Z" target="_blank" rel="noreferrer" class="group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-white/5 hover:bg-[#25D366] rounded-2xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-[#25D366]/30" title="WhatsApp">
          <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-7 h-7 text-zinc-300 group-hover:text-white transition-colors duration-300"><title>WhatsApp</title><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/></svg>
        </a>
        <a href="https://www.linkedin.com/company/knurdz" target="_blank" rel="noreferrer" class="group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-white/5 hover:bg-[#0077B5] rounded-2xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-[#0077B5]/30" title="LinkedIn">
          <Linkedin size={28} class="text-zinc-300 group-hover:text-white transition-colors duration-300" />
        </a>
        <a href="https://www.youtube.com/@knurdz" target="_blank" rel="noreferrer" class="group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-white/5 hover:bg-[#FF0000] rounded-2xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-[#FF0000]/30" title="YouTube">
          <Youtube size={28} class="text-zinc-300 group-hover:text-white transition-colors duration-300" />
        </a>
        <a href="https://www.instagram.com/knurdz_org" target="_blank" rel="noreferrer" class="group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-white/5 hover:bg-[#E1306C] rounded-2xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-[#E1306C]/30" title="Instagram">
          <Instagram size={28} class="text-zinc-300 group-hover:text-white transition-colors duration-300" />
        </a>
        <a href="https://www.facebook.com/people/Knurdz/61579574973113/" target="_blank" rel="noreferrer" class="group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-white/5 hover:bg-[#1877F2] rounded-2xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-[#1877F2]/30" title="Facebook">
          <Facebook size={28} class="text-zinc-300 group-hover:text-white transition-colors duration-300" />
        </a>
        <a href="https://x.com/knurdz_org" target="_blank" rel="noreferrer" class="group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-white/5 hover:bg-black border border-transparent hover:border-white/10 rounded-2xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-white/10" title="X (Twitter)">
          <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-7 h-7 p-0.5 text-zinc-300 group-hover:text-white transition-colors duration-300"><title>X</title><path d="M14.234 10.162 22.977 0h-2.072l-7.591 8.824L7.251 0H.258l9.168 13.343L.258 24H2.33l8.016-9.318L16.749 24h6.993zm-2.837 3.299-.929-1.329L3.076 1.56h3.182l5.965 8.532.929 1.329 7.754 11.09h-3.182z"/></svg>
        </a>
        <a href="https://www.tiktok.com/@knurdz_org" target="_blank" rel="noreferrer" class="group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-white/5 hover:bg-[#333333] rounded-2xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-black/20" title="TikTok">
        ...
        <a href="mailto:hello@knurdz.org" class="group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-white/5 hover:bg-[#D44638] rounded-2xl transition-all duration-300 hover:scale-110 hover:-translate-y-1 shadow-lg hover:shadow-[#D44638]/30" title="Email Us">
          <Mail size={28} class="text-zinc-300 group-hover:text-white transition-colors duration-300" />
        </a>
      </div>
    </div>
  </section>
